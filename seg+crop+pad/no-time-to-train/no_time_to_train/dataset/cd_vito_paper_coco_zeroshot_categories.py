...
if __name__ == "__main__":
    ...
    with open('./data/coco/annotations/instances_train2017.json', 'r') as fin:
    ...
    with open('./data/coco/annotations/instances_val2017.json', 'r') as fin:
    ...
    with open('./data/coco/annotations_refsam2/ovd_ins_train2017_b.json', 'w') as fout:
        json.dump(coco_train_anno_seen, fout)
    with open('./data/coco/annotations_refsam2/ovd_ins_train2017_t.json', 'w') as fout:
        json.dump(coco_train_anno_unseen, fout)
    with open('./data/coco/annotations_refsam2/ovd_ins_train2017_all.json', 'w') as fout:
        json.dump(coco_train_anno_all, fout)
    with open('./data/coco/annotations_refsam2/ovd_ins_val2017_b.json', 'w') as fout:
        json.dump(coco_val_anno_seen, fout)
    with open('./data/coco/annotations_refsam2/ovd_ins_val2017_t.json', 'w') as fout:
        json.dump(coco_val_anno_unseen, fout)
    with open('./data/coco/annotations_refsam2/ovd_ins_val2017_all.json', 'w') as fout:
